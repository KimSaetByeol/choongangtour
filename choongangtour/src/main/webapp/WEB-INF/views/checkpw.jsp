...
<div id="infobox">
	...
	<form action="./myinfo.do" method="post">
		${sessionScope.l_name }님, 본인 확인을 위해 비밀번호를 입력하세요.<br> 
		비밀번호 : <input type="password" name="l_pw" id="l_pw" required="required">
		<input type="hidden" name="l_id" id="l_id" value="${sessionScope.l_id}">
		<button type="submit" onclick="return chk(${sessionScope.pwFailCnt})">확인</button>
	</form>
</div>
</body>
</html>